	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __('Post Type', 'acf-post_types');
		...
		*  var message = acf._e('post_types', 'error');
		*/
		
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-post_types'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		/*acf_render_field_setting( $field, array(
			'label'			=> __('Font Size','acf-post_types'),
			'instructions'	=> __('Customise the input font size','acf-post_types'),
			'type'			=> 'number',
			'name'			=> 'font_size',
			'prepend'		=> 'px',
		));*/
...
/*
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-post_types', "{$dir}js/input.js" );
		wp_enqueue_script('acf-input-post_types');
		
		
		// register & include CSS
		wp_register_style( 'acf-input-post_types', "{$dir}css/input.css" ); 
		wp_enqueue_style('acf-input-post_types');
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-post_types'),
		}
